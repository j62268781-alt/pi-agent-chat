...
} from "../../services/models/models-config.ts";
import {
  ...
  getModelRuntime,
} from "../../services/models/auth-config.ts";
import {
  startOAuthFlow,
  type OAuthFlowController,
  type OAuthProgressEvent,
} from "../../services/models/oauth-flow.ts";
import {
  listAgents,
  writeAgent,
  deleteAgent,
...
import {
  ...
  nameExistsInScope,
  writePrompt,
} from "../../services/prompts/prompts-config.ts";
import {
  classifySkillScope,
  createSkill,
  deleteSkill,
  ...
  readSkillBody,
  updateSkill,
} from "../../services/skills/skills-config.ts";
import {
  addServer,
  deleteServer,
  ensureMcpJson,
  ...
  toggleDisabled,
  updateServer,
} from "../../services/mcp/mcp-config.ts";

const SETTINGS_VIEW_TYPE = "pi-agent-chat.settingsPanel";
...
export async function openSettingsPanel(
  ...
  const langSub = vscode.workspace.onDidChangeConfiguration((e) => {
    if (e.affectsConfiguration("pi-agent-chat.language")) {
