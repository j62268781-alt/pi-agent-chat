...
export const SETTINGS_FIXTURES: SettingsTabDataMap = {
  ...
  agents: {
    ...
    agents: [
      ...
      },
      {
        ...
        disableModelInvocation: false,
        source: "project",
        filePath: "/Users/joeson/Documents/pi-agent-chat/.pi/agents/explore.md",
      },
    ],
  },
  ...
  settings: {
    ...
    // What the host derives from the model registry, so the two `default-*`
    // fields render their suggestion list here too.
    suggestions: {
      defaultProvider: ["qoder", "solar"],
      defaultModel: ["claude-sonnet-5", "glm-5.3-flash", "qwen-4-coder"],
    },
  },
};
